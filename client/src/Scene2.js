...
export class Scene2 extends Phaser.Scene {
    ...
    create() {
        ...
        // cursors = this.input.keyboard.createCursorKeys(); instea use WASD
    ...
    update(time, delta) {
        ...
        // Horizontal movement
        // if (cursors.left.isDown) { // instead its S key
    ...
    debugGraphics() {
        ...
        this.input.keyboard.on("keydown_H", event => {
            // If debug graphics are already shown, hide them
            if (this.debug) {
                ...
                this.debugGraphic = this.add
                    ...
                    .setAlpha(0.75)
                    .setDepth(20);
                this.worldLayer.renderDebug(this.debugGraphic, {
